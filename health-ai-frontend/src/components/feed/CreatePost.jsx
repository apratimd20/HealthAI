  ...
  return (
    <Card className="mb-6" glow>
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="font-bold text-fg">Share Your Health Journey</h3>
          <p className="text-sm text-fg-muted">Post a workout, meal, progress, or tip</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <textarea
          ...
          placeholder="What's on your mind? Share your health update..."
          rows={3}
          className="w-full resize-none rounded-lg border border-border-default bg-surface-muted px-4 py-2.5 text-sm text-fg placeholder-fg-subtle focus:border-brand focus:outline-none"
        />
        ...
        {!previewUrl ? (
          <div
            ...
            className="flex cursor-pointer items-center gap-3 rounded-lg border border-dashed border-border-default bg-surface-muted/30 px-4 py-3 text-sm text-fg-muted transition hover:border-brand hover:text-brand"
          >
          ...
          <div className="relative rounded-xl overflow-hidden bg-surface-muted">
            ...
            />
            <button
              onClick={() => { setPreviewUrl(null); setImage(null); if (fileInputRef.current) fileInputRef.current.value = ''; }}
        ...
        <input
          ...
          placeholder="Food name (if sharing a meal)"
