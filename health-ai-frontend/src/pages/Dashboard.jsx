...
export default function Dashboard() {
  ...
  const handleScanComplete = async (scanData) => {
    toast.success(`✅ Added ${scanData.foodName} to your daily log!`);
    // TODO: Call API to update daily totals
    await fetchDashboardData();
  };
  ...
  🔔 Enable Notifications
      ...
      {!showPlan ? (
        ...
        <motion.div
          ...
          animate="animate"
        >
          <motion.div variants={staggerItem} className="mb-2 flex flex-wrap items-center justify-between gap-3">
            <div>
