...
export const setGoal = async (req, res) => {
  try {
    ...
    const newGoal = await Goal.create({
      ...
      alcoholConsumption: alcoholConsumption || 'rarely',
      dailySteps: dailySteps || 5000,
      
      // Dietary Preferences
      foodPreference: foodPreference || 'non-vegetarian',
      mealFrequency: mealFrequency || 3,
      waterIntake: waterIntake || 2.5,
      caffeineIntake: caffeineIntake || 100,
      sugarIntake: sugarIntake || 25,
...
export const getNotifications = async (req, res) => {
  try {
    ...
    // Get meal recommendations based on food preference
    ...
    const exerciseSchedule = [1, 3, 5]; // Mon, Wed, Fri
